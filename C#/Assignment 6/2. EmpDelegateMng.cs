...
namespace EmpDelegateMng
{
    ...
    class EmployeeManagementMain
    {
        static void Main()
        {
            ...
            empDlg += DisplayMarketingDetails;
            empDlg();
        }
        ...
        public static void DisplayMarketingDetails()
        {
            Employee obj = new MarketingExecutive("Aether", "Twilight", "Marketing Executive", 123456, 10);
            obj.CalculateSalary();
            Console.WriteLine("EMPLOYEE DETAILS:\n");
            Console.WriteLine("Name: {0} {1}", obj.firstName, obj.lastName);
            Console.WriteLine("Designation: {0}", obj.designation);
